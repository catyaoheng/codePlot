    ...
    for line in lines:
        ...
        if (valueNum == '21'):
            ...
            for i in range(len(valueNameList)):
                ...
                aboveValuePossitiveNum = sum(valuePossitiveSortedList[i+1:])
                belowValuePossitiveNum = sum(valuePossitiveSortedList[:i])
                aboveValueNegativeNum = sum(valueNegativeSortedList[i+1:])
                belowValueNegativeNum = sum(valueNegativeSortedList[:i])
